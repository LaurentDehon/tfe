                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="flex space-x-2 mt-1">
                                <button wire:click="moveUp({{ $milestone->id }})" class="text-xs text-gray-500 hover:text-blue-600" @if($loop->first) disabled @endif>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z" clip-rule="evenodd" />
                                    </svg>
                                </button>
                                <button wire:click="moveDown({{ $milestone->id }})" class="text-xs text-gray-500 hover:text-blue-600" @if($loop->last) disabled @endif>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <form wire:submit.prevent="saveMilestone">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" id="title" wire:model="milestone.title" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                                @error('milestone.title') <span class="text-red-500 text-sm mt-1">{{ $message }}</span> @enderror
                            </div>
                            
                            <div class="col-span-6 sm:col-span-3">
                                <label for="position" class="block text-sm font-medium text-gray-700">Position</label>
                                <input type="number" id="position" wire:model="milestone.position" min="0" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                                @error('milestone.position') <span class="text-red-500 text-sm mt-1">{{ $message }}</span> @enderror
                            </div>
                            
                            <div class="col-span-6">
                                <label for="description" class="block text-sm font-medium text-gray-700">Description</label>
                                <textarea id="description" rows="4" wire:model="milestone.description" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"></textarea>
                            ...
                            <div class="col-span-6">
                                ...
                                <input type="file" id="document_template" wire:model="documentTemplate" class="mt-1 block w-full">
                                @if($milestone['document_template_path'])
                            ...
                            <div class="col-span-6">
                                ...
                                <input type="text" id="tools" wire:model="milestone.tools" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                            ...
                            <div class="col-span-6">
                                ...
                                <input type="text" id="concepts" wire:model="milestone.concepts" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                            ...
                            <div class="col-span-6">
                                ...
                                <input type="text" id="courses" wire:model="milestone.courses" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
