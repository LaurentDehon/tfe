<div>
    <div class="mb-6 flex justify-between items-center">
        <h1 class="text-2xl font-semibold text-gray-900">Gestion des concepts</h1>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($concepts as $concept)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-500">{{ $concept->created_at->format('d/m/Y') }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                            ...
                            <button 
                                wire:click="delete({{ $concept->id }})"
                                onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce concept ?')" 
